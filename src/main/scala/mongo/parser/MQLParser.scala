...
private[parser] final class LangParser extends JavaTokenParsers with PackratParsers {
  import MqlParser._
...
object MqlParser {
  ...
  trait MqlValue extends MqlExpression {
    type T <: AnyRef
    def value: T
  }
  ...
  def apply() = new LangParser

  def main(args: Array[String]): Unit = {
    val line = """{ "dt" : { "$gt" : "13 Feb 2015 10:34:47:273 PM MSK" } }"""
    println(MqlParser().parse(line))
  }
}